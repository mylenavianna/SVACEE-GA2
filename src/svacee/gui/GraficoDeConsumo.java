...
public class GraficoDeConsumo extends javax.swing.JFrame {

    DadoConsumoCtrl dcc = new DadoConsumoCtrl();
    
    public GraficoDeConsumo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jlTitulo.setFont(new java.awt.Font("Noto Sans", 1, 24)); // NOI18N
        jlTitulo.setForeground(new java.awt.Color(0, 153, 153));
        jlTitulo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlTitulo.setText("Gráfico de Consumo de Energia");

        jbSair.setIcon(new javax.swing.ImageIcon(getClass().getResource("/svacee/gui/img/sair24.png"))); // NOI18N
        jbSair.setText("Sair");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GraficoDeConsumo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GraficoDeConsumo().setVisible(true);
            }
        });
    }
